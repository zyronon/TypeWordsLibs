!function () {
  ...
  (t => {
    const {
      ...
      top: u,
      doNotTrack: d
    } = t, {currentScript: l, referrer: f} = c;
    if (!l) return;
    const {hostname: h, href: m, origin: p} = o, y = m.startsWith("data:") ? void 0 : t.localStorage, g = "data-",
      b = "true", $ = l.getAttribute.bind(l), v = $(`${g}website-id`), w = $(`${g}host-url`), S = $(`${g}before-send`),
      ...
      U = /data-umami-event-([\w-_]+)/, _ = `${g}umami-event`, D = 300, P = t => {
        ...
        if ("function" == typeof r && (e = await Promise.resolve(r(a, e))), e) try {
          const t = await fetch(K, {
            ...
            headers: {"Content-Type": "application/json", ...void 0 !== z && {"x-umami-cache": z}},
            credentials: L
          }), r = await t.json();
        ...
        M || (M = !0, J(), (() => {
          ...
          c.addEventListener("click", async e => {
            const a = e.target, r = a.closest("a,button");
            if (!r) return t(a);
        ...
        name: t,
        data: e
      } : "object" == typeof t ? {...t} : "function" == typeof t ? t(R()) : R()),
      q = (t, e) => ("string" == typeof t && (F = t), z = "", C({
        ...R(),
        data: "object" == typeof t ? t : e
      }, "identify"));
    t.umami || (t.umami = {track: J, identify: q});
    let z, F, G = P(m), H = P(f.startsWith(p) ? "" : f), M = !1, Q = !1;
